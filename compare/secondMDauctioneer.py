...
if __name__ == '__main__':
    ...
    # strategy[0] = 4
    auctioneer = Auctioneer1(winner=[], average_winner_bid=[], average_winner_fact_bid=[], cumulative_total_profits=[], starting_prices=[], data=5e5, cycles=10e8, time=0.8, f_m=1e9, Pm=0.3, N_buyers=10, K_sellers=3,
