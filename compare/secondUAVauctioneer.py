...
if __name__ == '__main__':
    ...
    # strategy[0] = 4
    auctioneer = Auctioneer5(average_winner_bid=[], average_winner_fact_bid=[], winner=[], winner_profit=[], starting_prices=[], data=5e5, cycles=10e8, time=0.8, f_m=1e9, Pm=0.3, N_buyers=3, K_sellers=10,
